...
print("d_output_lbl_loss")
print(history.history['d_output_lbl_loss'])
print("d_output_loss")
print(history.history['d_output_loss'])
print("mrcnn_bbox_loss")
print(history.history['mrcnn_bbox_loss'])
